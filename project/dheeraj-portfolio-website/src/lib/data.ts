...
export const experiencesData = [
  {
    title: "Graduated Automobile Engineering",
  ...
  },
  {
    ...
    location: "Hyderabad, India",
    description:
      "I worked as an analyst for 7 months at RadarRadar Netherlands. I also upskilled to the Data engineering & Data analyst and full stack.",
    icon: Worksvg,
...
export const projectsData = [
  ...
  },
  {
    ...
    tags: ["JavaScript", "CSS", "HML", "Web Application"],
